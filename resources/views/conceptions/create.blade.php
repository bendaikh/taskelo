...
@section('title', 'Create Conception')
@section('page-title', 'Create Conception')

@section('content')
<div class="max-w-4xl">
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        <form method="POST" action="{{ route('conceptions.store') }}" id="conception-form">
            @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <select
                                ...
                                class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-primary-500">
                                <option value="fixed" {{ old('remise_type', 'fixed') === 'fixed' ? 'selected' : '' }}>Fixed amount</option>
                                <option value="percent" {{ old('remise_type') === 'percent' ? 'selected' : '' }}>Percentage (%)</option>
                            </select>
                        </div>
                        <div>
