        ...
        <form method="POST" action="{{ route('clients.update', $client) }}">
            ...
            <div class="mt-6">
                ...
                <textarea 
                    ...
                    id="address" 
                    rows="3"
                    class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-primary-500">{{ old('address', $client->address) }}</textarea>
            </div>
