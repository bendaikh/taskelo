            ...
            <div class="mb-6">
                ...
                <div class="space-y-4 bg-gray-50 dark:bg-gray-900 p-4 rounded-lg">
                    ...
                    <div class="border-b border-gray-200 dark:border-gray-700 pb-3">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="dashboard.view" class="mr-2 rounded">
                    ...
                    <div class="border-b border-gray-200 dark:border-gray-700 pb-3">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="projects.view" class="mr-2 rounded">
                                <span class="text-sm text-gray-700 dark:text-gray-300">View Projects</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="projects.create" class="mr-2 rounded">
                                <span class="text-sm text-gray-700 dark:text-gray-300">Create Projects</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="projects.edit" class="mr-2 rounded">
                                <span class="text-sm text-gray-700 dark:text-gray-300">Edit Projects</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="projects.delete" class="mr-2 rounded">
                    ...
                    <div class="border-b border-gray-200 dark:border-gray-700 pb-3">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="businesses.view" class="mr-2 rounded">
                                <span class="text-sm text-gray-700 dark:text-gray-300">View My Business</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="businesses.create" class="mr-2 rounded">
                                <span class="text-sm text-gray-700 dark:text-gray-300">Create Business</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="businesses.edit" class="mr-2 rounded">
                                <span class="text-sm text-gray-700 dark:text-gray-300">Edit Business</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="businesses.delete" class="mr-2 rounded">
                    ...
                    <div class="border-b border-gray-200 dark:border-gray-700 pb-3">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="clients.view" class="mr-2 rounded">
                                <span class="text-sm text-gray-700 dark:text-gray-300">View Clients</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="clients.create" class="mr-2 rounded">
                                <span class="text-sm text-gray-700 dark:text-gray-300">Create Clients</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="clients.edit" class="mr-2 rounded">
                                <span class="text-sm text-gray-700 dark:text-gray-300">Edit Clients</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="clients.delete" class="mr-2 rounded">
                    ...
                    <div class="border-b border-gray-200 dark:border-gray-700 pb-3">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="payments.view" class="mr-2 rounded">
                                <span class="text-sm text-gray-700 dark:text-gray-300">View Payments</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="payments.create" class="mr-2 rounded">
                                <span class="text-sm text-gray-700 dark:text-gray-300">Create Payments</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="payments.edit" class="mr-2 rounded">
                                <span class="text-sm text-gray-700 dark:text-gray-300">Edit Payments</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="payments.delete" class="mr-2 rounded">
                                <span class="text-sm text-gray-700 dark:text-gray-300">Delete Payments</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="payments.export" class="mr-2 rounded">
                    ...
                    <div class="border-b border-gray-200 dark:border-gray-700 pb-3">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="proposals.view" class="mr-2 rounded">
                                <span class="text-sm text-gray-700 dark:text-gray-300">View Proposals</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="proposals.create" class="mr-2 rounded">
                                <span class="text-sm text-gray-700 dark:text-gray-300">Create Proposals</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="proposals.edit" class="mr-2 rounded">
                                <span class="text-sm text-gray-700 dark:text-gray-300">Edit Proposals</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="proposals.delete" class="mr-2 rounded">
                    ...
                    <div class="border-b border-gray-200 dark:border-gray-700 pb-3">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="conceptions.view" class="mr-2 rounded">
                                <span class="text-sm text-gray-700 dark:text-gray-300">View Conceptions</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="conceptions.create" class="mr-2 rounded">
                                <span class="text-sm text-gray-700 dark:text-gray-300">Create Conceptions</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="conceptions.edit" class="mr-2 rounded">
                                <span class="text-sm text-gray-700 dark:text-gray-300">Edit Conceptions</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="conceptions.delete" class="mr-2 rounded">
                    ...
                    <div class="border-b border-gray-200 dark:border-gray-700 pb-3">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="revenue.view" class="mr-2 rounded">
                                <span class="text-sm text-gray-700 dark:text-gray-300">View Revenue</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="revenue.create" class="mr-2 rounded">
                                <span class="text-sm text-gray-700 dark:text-gray-300">Create Revenue</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="revenue.delete" class="mr-2 rounded">
                    ...
                    <div class="border-b border-gray-200 dark:border-gray-700 pb-3">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="expenses.view" class="mr-2 rounded">
                                <span class="text-sm text-gray-700 dark:text-gray-300">View Expenses</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="expenses.create" class="mr-2 rounded">
                                <span class="text-sm text-gray-700 dark:text-gray-300">Create Expenses</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="expenses.delete" class="mr-2 rounded">
                    ...
                    <div class="border-b border-gray-200 dark:border-gray-700 pb-3">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="categories.view" class="mr-2 rounded">
                                <span class="text-sm text-gray-700 dark:text-gray-300">View Categories</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="categories.create" class="mr-2 rounded">
                                <span class="text-sm text-gray-700 dark:text-gray-300">Create Categories</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="categories.delete" class="mr-2 rounded">
                    ...
                    <div class="border-b border-gray-200 dark:border-gray-700 pb-3">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="tasks.view" class="mr-2 rounded">
                                <span class="text-sm text-gray-700 dark:text-gray-300">View Tasks</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="tasks.create" class="mr-2 rounded">
                                <span class="text-sm text-gray-700 dark:text-gray-300">Create Tasks</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="tasks.edit" class="mr-2 rounded">
                                <span class="text-sm text-gray-700 dark:text-gray-300">Edit Tasks</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="tasks.delete" class="mr-2 rounded">
                    ...
                    <div class="border-b border-gray-200 dark:border-gray-700 pb-3">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="analytics.view" class="mr-2 rounded">
                    ...
                    <div class="border-b border-gray-200 dark:border-gray-700 pb-3">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="users.view" class="mr-2 rounded">
                                <span class="text-sm text-gray-700 dark:text-gray-300">View Users</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="users.create" class="mr-2 rounded">
                                <span class="text-sm text-gray-700 dark:text-gray-300">Create Users</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="users.edit" class="mr-2 rounded">
                                <span class="text-sm text-gray-700 dark:text-gray-300">Edit Users</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="users.delete" class="mr-2 rounded">
                    ...
                    <div class="border-b border-gray-200 dark:border-gray-700 pb-3">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="roles.view" class="mr-2 rounded">
                                <span class="text-sm text-gray-700 dark:text-gray-300">View Roles</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="roles.create" class="mr-2 rounded">
                                <span class="text-sm text-gray-700 dark:text-gray-300">Create Roles</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="roles.edit" class="mr-2 rounded">
                                <span class="text-sm text-gray-700 dark:text-gray-300">Edit Roles</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="roles.delete" class="mr-2 rounded">
                    ...
                    <div class="border-b border-gray-200 dark:border-gray-700 pb-3">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="workspaces.view" class="mr-2 rounded">
                                <span class="text-sm text-gray-700 dark:text-gray-300">View Workspaces</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="workspaces.create" class="mr-2 rounded">
                                <span class="text-sm text-gray-700 dark:text-gray-300">Create Workspaces</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="workspaces.edit" class="mr-2 rounded">
                                <span class="text-sm text-gray-700 dark:text-gray-300">Edit Workspaces</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="workspaces.delete" class="mr-2 rounded">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="settings.view" class="mr-2 rounded">
                                <span class="text-sm text-gray-700 dark:text-gray-300">View Settings</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="settings.edit" class="mr-2 rounded">
