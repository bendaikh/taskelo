                ...
                <div 
                    ...
                    <div class="py-1">
                        <form method="POST" action="{{ route('settings.language') }}">
                            ...
                            <button type="submit" class="w-full px-4 py-2 text-left text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 flex items-center space-x-2 {{ (Auth::user()->language ?? 'en') === 'en' ? 'bg-blue-50 dark:bg-blue-900/20' : '' }}">
                                <span class="text-lg">🇬🇧</span>
                                <span>{{ __('app.english') }}</span>
                                @if((Auth::user()->language ?? 'en') === 'en')
                        ...
                        <form method="POST" action="{{ route('settings.language') }}">
                            ...
                            <button type="submit" class="w-full px-4 py-2 text-left text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 flex items-center space-x-2 {{ (Auth::user()->language ?? 'en') === 'fr' ? 'bg-blue-50 dark:bg-blue-900/20' : '' }}">
                                <span class="text-lg">🇫🇷</span>
                                <span>{{ __('app.french') }}</span>
                                @if((Auth::user()->language ?? 'en') === 'fr')
                                <svg class="w-4 h-4 ml-auto text-blue-600" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
                                </svg>
                                @endif
                    ...
                    <div class="p-2">
                        ...
                        <a href="{{ route('workspaces.create') }}" class="block px-3 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors">
                            <div class="flex items-center space-x-2">
                                ...
                                <span>{{ __('app.create_workspace') }}</span>
                            </div>
                        </a>
                        <a href="{{ route('workspaces.index') }}" class="block px-3 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors">
                            <div class="flex items-center space-x-2">
                                ...
                                <span>{{ __('app.manage_workspaces') }}</span>
                            </div>
                        </a>
                    </div>
                </div>
