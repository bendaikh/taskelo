...
@section('page-title', 'Add Revenue Category')

@section('content')
<div class="max-w-xl">
  <form action="{{ route('revenue-categories.store') }}" method="POST" class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 space-y-4">
    @csrf
    <div>
    ...
    <div class="flex items-center justify-end gap-3">
      <a href="{{ route('revenue-categories.index') }}" class="px-4 py-2 bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 rounded">Cancel</a>
