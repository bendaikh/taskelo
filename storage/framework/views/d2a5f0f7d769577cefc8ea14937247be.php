            ...
            <table class="section-header-table">
                <tr>
                    ...
                    <td class="section-name" style="vertical-align: middle;">
                        ...
                        <?php if(!empty($section['time_range'])): ?>
                            <div style="font-size: 10px; color: #666; font-weight: normal; margin-top: 3px;">
                                <svg style="display: inline-block; width: 10px; height: 10px; margin-right: 2px;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                </svg>
                                <?php echo e($trans['time_range']); ?>: <?php echo e($section['time_range']); ?>
