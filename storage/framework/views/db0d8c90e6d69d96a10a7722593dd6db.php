                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <select
                                ...
                                class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-primary-500">
                                <option value="fixed" <?php echo e(old('remise_type', $conception->remise_type ?? 'fixed') === 'fixed' ? 'selected' : ''); ?>>Fixed amount</option>
                                <option value="percent" <?php echo e(old('remise_type', $conception->remise_type ?? 'fixed') === 'percent' ? 'selected' : ''); ?>>Percentage (%)</option>
                            </select>
                        </div>
                        <div>
                            ...
                            <input
                                ...
                                name="remise"
                                id="remise"
                                value="<?php echo e(old('remise', $conception->remise ?? 0)); ?>"
                                min="0"
                                step="0.01"
                                onchange="updateTotal()"
                                oninput="updateTotal()"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div id="total-price-container" class="mt-4 p-4 bg-gray-100 dark:bg-gray-700 rounded-lg space-y-2">
                    <div class="flex items-center justify-between text-gray-700 dark:text-gray-300">
                        <span>Subtotal:</span>
                        <span id="subtotal-price"><span class="currency-symbol"><?php echo e($conception->currency ?? 'USD'); ?></span> 0.00</span>
                    </div>
                    <div id="remise-row" class="flex items-center justify-between text-red-600 dark:text-red-400 hidden">
                        <span>Remise:</span>
                        <span id="remise-amount">-<span class="currency-symbol"><?php echo e($conception->currency ?? 'USD'); ?></span> 0.00</span>
                    </div>
                    <div class="flex items-center justify-between pt-2 border-t border-gray-300 dark:border-gray-600">
                        ...
                        <span id="total-price" class="text-2xl font-bold text-primary-600 dark:text-primary-400">
                            <span class="currency-symbol"><?php echo e($conception->currency ?? 'USD'); ?></span> 0.00
                        </span>
                    </div>
                </div>
            </div>
