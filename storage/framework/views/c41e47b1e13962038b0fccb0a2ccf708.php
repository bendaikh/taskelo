...
<div class="mb-6 flex flex-col md:flex-row md:justify-between md:items-start space-y-4 md:space-y-0">
    ...
    <div class="flex space-x-2">
        <a href="<?php echo e(route('payments.export.csv')); ?>?<?php echo e(http_build_query(request()->all())); ?>" class="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 text-sm">
            Export CSV
        </a>
        <a href="<?php echo e(route('payments.export.pdf')); ?>?<?php echo e(http_build_query(request()->all())); ?>" class="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 text-sm">
            Export PDF
        </a>
        <a href="<?php echo e(route('payments.create')); ?>" class="px-4 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700 text-sm">
            + Add Payment
        </a>
    </div>
</div>
