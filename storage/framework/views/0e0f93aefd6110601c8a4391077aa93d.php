...
<?php $__env->startSection('page-title', __('app.settings')); ?>

<?php $__env->startSection('content'); ?>
<div class="max-w-4xl">
    <!-- Profile Settings -->
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 mb-6">
        <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-4"><?php echo e(__('app.profile_settings')); ?></h3>
        <form method="POST" action="<?php echo e(route('settings.profile')); ?>" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <!-- Name -->
                <div>
                    <label for="name" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2"><?php echo e(__('app.name')); ?> *</label>
                    <input 
                        type="text" 
                        name="name" 
                        id="name" 
...
unset($__errorArgs, $__bag); ?>
                ...
                <!-- Email -->
                <div>
                    <label for="email" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2"><?php echo e(__('app.email')); ?> *</label>
                    <input 
                        type="email" 
                        name="email" 
                        id="email" 
...
unset($__errorArgs, $__bag); ?>
                ...
                <!-- Company Name -->
                <div>
                    <label for="company_name" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2"><?php echo e(__('app.company_name')); ?></label>
                    <input
                        type="text"
                        name="company_name"
                        id="company_name"
...
unset($__errorArgs, $__bag); ?>
                ...
                <!-- Company Website -->
                <div>
                    <label for="company_website" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2"><?php echo e(__('app.company_website')); ?></label>
                    <input
                        type="url"
...
unset($__errorArgs, $__bag); ?>
            ...
            <!-- Logo -->
            <div class="mt-6">
                <label for="logo" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2"><?php echo e(__('app.logo')); ?></label>
                <?php if($user->logo): ?>
                    <div class="mb-2">
                ...
                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1"><?php echo e(__('app.max_size')); ?></p>
            </div>

            <!-- Submit Button -->
            <div class="mt-6">
                <button type="submit" class="px-4 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700">
                    <?php echo e(__('app.update_profile')); ?>
    ...
    <!-- Password Settings -->
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 mb-6">
        <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-4"><?php echo e(__('app.change_password')); ?></h3>
        <form method="POST" action="<?php echo e(route('settings.password')); ?>">
            ...
            <div class="space-y-4">
                <!-- Current Password -->
                <div>
                    <label for="current_password" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2"><?php echo e(__('app.current_password')); ?> *</label>
                    <input 
                        type="password" 
...
unset($__errorArgs, $__bag); ?>
                ...
                <!-- New Password -->
                <div>
                    <label for="password" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2"><?php echo e(__('app.new_password')); ?> *</label>
                    <input 
                        type="password" 
                        name="password" 
                        id="password" 
...
unset($__errorArgs, $__bag); ?>
                ...
                <!-- Confirm Password -->
                <div>
                    <label for="password_confirmation" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2"><?php echo e(__('app.confirm_new_password')); ?> *</label>
                    <input 
                        type="password" 
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-4"><?php echo e(__('app.preferences')); ?></h3>
        <form method="POST" action="<?php echo e(route('settings.preferences')); ?>">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <!-- Currency -->
                <div>
                    <label for="currency" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2"><?php echo e(__('app.currency')); ?> *</label>
                    <select 
                        name="currency" 
                        id="currency" 
                        required
                        ...
                        <option value="XOF" <?php echo e($user->currency === 'XOF' ? 'selected' : ''); ?>>CFA (FCFA)</option>
                        <option value="XAF" <?php echo e($user->currency === 'XAF' ? 'selected' : ''); ?>>CFA Central (FCFA)</option>
                    </select>
                </div>

                <!-- Theme -->
                <div>
                    <label for="theme" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2"><?php echo e(__('app.theme')); ?> *</label>
                    <select 
                        name="theme" 
                        id="theme" 
                        required
                        class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-primary-500">
                        <option value="light" <?php echo e($user->theme === 'light' ? 'selected' : ''); ?>><?php echo e(__('app.light')); ?></option>
                        <option value="dark" <?php echo e($user->theme === 'dark' ? 'selected' : ''); ?>><?php echo e(__('app.dark')); ?></option>
                    </select>
                </div>

                <!-- Language -->
                <div>
                    <label for="language" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2"><?php echo e(__('app.language')); ?> *</label>
                    <select 
                        name="language" 
                        id="language" 
                        required
                        class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-primary-500">
                        <option value="en" <?php echo e(($user->language ?? 'en') === 'en' ? 'selected' : ''); ?>><?php echo e(__('app.english')); ?></option>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mt-6">
                <button type="submit" class="px-4 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700">
                    <?php echo e(__('app.update_preferences')); ?>
