<?php $__env->startSection('title', __('app.proposals')); ?>
<?php $__env->startSection('page-title', __('app.proposals')); ?>
...
<div class="mb-6 flex flex-col md:flex-row md:justify-between md:items-start space-y-4 md:space-y-0">
    ...
    <a href="<?php echo e(route('proposals.create')); ?>" class="px-4 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700 whitespace-nowrap text-center">
        + <?php echo e(__('app.add_proposal')); ?>
            ...
            <?php $__empty_1 = true; $__currentLoopData = $proposals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proposal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <?php else: ?>
                            <span class="text-gray-400 dark:text-gray-500 italic"><?php echo e(__('app.no_clients')); ?></span>
                        <?php endif; ?>
                    </td>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <span class="px-2 py-1 text-xs rounded-full 
                            ...
                            <?php endif; ?>">
                            <?php echo e(__('app.' . $proposal->status)); ?>

                        </span>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <div class="flex justify-end items-center space-x-2">
                            <a href="<?php echo e(route('proposals.view-pdf', $proposal)); ?>" target="_blank" class="text-blue-600 hover:text-blue-900 dark:text-blue-400" title="<?php echo e(__('app.view_pdf')); ?>">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path>
                                </svg>
                            </a>
                            <a href="<?php echo e(route('proposals.pdf', $proposal)); ?>" class="text-green-600 hover:text-green-900 dark:text-green-400" title="<?php echo e(__('app.download_pdf')); ?>">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path>
                                </svg>
                            </a>
                            <a href="<?php echo e(route('proposals.edit', $proposal)); ?>" class="text-blue-600 hover:text-blue-900 dark:text-blue-400"><?php echo e(__('app.edit')); ?></a>
                            <form action="<?php echo e(route('proposals.destroy', $proposal)); ?>" method="POST" class="inline" onsubmit="return confirm('<?php echo e(__('app.are_you_sure')); ?>');">
                                <?php echo csrf_field(); ?>
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <tr>
                    <td colspan="7" class="px-6 py-8 text-center text-gray-500 dark:text-gray-400">
                        <?php echo e(__('app.no_proposals')); ?>. <a href="<?php echo e(route('proposals.create')); ?>" class="text-primary-600 dark:text-primary-400 hover:text-primary-700"><?php echo e(__('app.add_proposal')); ?></a>
                    </td>
                </tr>
            <?php endif; ?>
        </tbody>
...
<div class="md:hidden space-y-4">
    <?php $__empty_1 = true; $__currentLoopData = $proposals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proposal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
            ...
            <div class="flex items-center justify-between pt-3 border-t border-gray-200 dark:border-gray-700">
                ...
                <div class="flex space-x-3">
                    <a href="<?php echo e(route('proposals.edit', $proposal)); ?>" class="text-blue-600 hover:text-blue-900 dark:text-blue-400 text-sm"><?php echo e(__('app.edit')); ?></a>
                    <form action="<?php echo e(route('proposals.destroy', $proposal)); ?>" method="POST" class="inline" onsubmit="return confirm('<?php echo e(__('app.are_you_sure')); ?>');">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('DELETE'); ?>
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-8 text-center">
            <p class="text-gray-500 dark:text-gray-400 mb-4"><?php echo e(__('app.no_proposals')); ?>.</p>
            <a href="<?php echo e(route('proposals.create')); ?>" class="text-primary-600 dark:text-primary-400 hover:text-primary-700"><?php echo e(__('app.add_proposal')); ?></a>
        </div>
    <?php endif; ?>
</div>
