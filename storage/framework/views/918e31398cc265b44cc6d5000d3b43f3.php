...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        <div class="flex items-center justify-between">
            <div>
                <p class="text-gray-500 dark:text-gray-400 text-sm"><?php echo e(__('app.total_projects')); ?></p>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        <div class="flex items-center justify-between">
            <div>
                <p class="text-gray-500 dark:text-gray-400 text-sm"><?php echo e(__('app.active_clients')); ?></p>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        <div class="flex items-center justify-between">
            <div>
                <p class="text-gray-500 dark:text-gray-400 text-sm"><?php echo e(__('app.total_revenue')); ?></p>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        <div class="flex items-center justify-between">
            <div>
                <p class="text-gray-500 dark:text-gray-400 text-sm"><?php echo e(__('app.pending_payments')); ?></p>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        <div class="flex items-center justify-between">
            <div>
                <p class="text-gray-500 dark:text-gray-400 text-sm"><?php echo e(__('app.total_expenses')); ?></p>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        <div class="flex items-center justify-between">
            <div>
                <p class="text-gray-500 dark:text-gray-400 text-sm"><?php echo e(__('app.net_cashflow')); ?></p>
                <p class="text-3xl font-bold mt-2 <?php echo e($netCashflow >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'); ?>"><?php echo e(Auth::user()->currency); ?> <?php echo e(number_format($netCashflow, 2)); ?></p>
            </div>
            <div class="p-3 rounded-lg <?php echo e($netCashflow >= 0 ? 'bg-green-100 dark:bg-green-900' : 'bg-red-100 dark:bg-red-900'); ?>">
                <svg class="w-8 h-8 <?php echo e($netCashflow >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-4"><?php echo e(__('app.monthly_revenue')); ?></h3>
    ...
    <!-- Daily Revenue Chart -->
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-4"><?php echo e(__('app.daily_revenue')); ?></h3>
        <div>
            <revenue-chart 
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-4"><?php echo e(__('app.payment_status')); ?></h3>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-4"><?php echo e(__('app.monthly_expenses')); ?></h3>
        <div>
            <expenses-chart 
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-4"><?php echo e(__('app.monthly_cashflow')); ?></h3>
        <div>
            <cashflow-chart 
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-4"><?php echo e(__('app.expenses_by_category')); ?></h3>
        <div>
            <expenses-by-category-chart 
                :data='<?php echo json_encode($expensesByCategory, 15, 512) ?>'
                :currency="'<?php echo e(Auth::user()->currency); ?>'"
                :available-years='<?php echo json_encode($availableExpenseYears, 15, 512) ?>'
                :initial-year='<?php echo json_encode($selectedCategoryYear, 15, 512) ?>'
                :initial-month='<?php echo json_encode($selectedCategoryMonth, 15, 512) ?>'
                :labels='<?php echo json_encode($expenseCategoryChartLabels, 15, 512) ?>'
                endpoint="<?php echo e(route('dashboard.expenses-by-category-data')); ?>">
            </expenses-by-category-chart>
        </div>
    </div>
</div>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
        <div class="p-6 border-b border-gray-200 dark:border-gray-700">
            <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-200"><?php echo e(__('app.tasks_in_progress')); ?></h3>
            <p class="text-sm text-gray-500 dark:text-gray-400"><?php echo e(__('app.tasks_in_progress_desc')); ?></p>
        </div>
        <div class="p-6">
            <?php $__empty_1 = true; $__currentLoopData = $inProgressTasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="py-3 border-b border-gray-200 dark:border-gray-700 last:border-0">
                    <div class="flex items-start justify-between">
                        ...
                        <span class="px-2 py-1 text-xs rounded-full bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-300"><?php echo e(__('app.in_progress')); ?></span>
                    </div>
                    <?php if($task->deadline): ?>
                        <p class="text-xs mt-1 text-gray-500 dark:text-gray-400"><?php echo e(__('app.due')); ?> <?php echo e($task->deadline->format('M d, Y')); ?></p>
                    <?php endif; ?>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <p class="text-gray-500 dark:text-gray-400 text-center py-4"><?php echo e(__('app.no_tasks_in_progress')); ?></p>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
        <div class="p-6 border-b border-gray-200 dark:border-gray-700">
            <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-200"><?php echo e(__('app.tasks_to_do')); ?></h3>
        ...
        <div class="p-6">
            <?php $__empty_1 = true; $__currentLoopData = $todoTasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="py-3 border-b border-gray-200 dark:border-gray-700 last:border-0">
                    <div class="flex items-start justify-between">
                        ...
                        <span class="px-2 py-1 text-xs rounded-full bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-300"><?php echo e(__('app.to_do')); ?></span>
                    </div>
                    <?php if($task->deadline): ?>
                        <p class="text-xs mt-1 text-gray-500 dark:text-gray-400"><?php echo e(__('app.due')); ?> <?php echo e($task->deadline->format('M d, Y')); ?></p>
                    <?php endif; ?>
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <p class="text-gray-500 dark:text-gray-400 text-center py-4"><?php echo e(__('app.no_tasks_to_do')); ?></p>
            <?php endif; ?>
        </div>
    </div>
</div>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
        <div class="p-6 border-b border-gray-200 dark:border-gray-700">
            <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-200"><?php echo e(__('app.recent_payments')); ?></h3>
        </div>
        <div class="p-6">
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <p class="text-gray-500 dark:text-gray-400 text-center py-4"><?php echo e(__('app.no_recent_payments')); ?></p>
            <?php endif; ?>
        </div>
        <div class="p-4 border-t border-gray-200 dark:border-gray-700">
            <a href="<?php echo e(route('payments.index')); ?>" class="text-primary-600 dark:text-primary-400 hover:text-primary-700 text-sm font-medium">
                <?php echo e(__('app.view_all_payments')); ?> →
            </a>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
        <div class="p-6 border-b border-gray-200 dark:border-gray-700">
            <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-200"><?php echo e(__('app.recent_projects')); ?></h3>
        </div>
        <div class="p-6">
                ...
                <div class="py-3 border-b border-gray-200 dark:border-gray-700 last:border-0">
                    <div class="flex items-center justify-between mb-2">
                        ...
                        <span class="px-2 py-1 text-xs rounded-full 
                            ...
                            <?php endif; ?>">
                            <?php echo e(__('app.' . $project->status)); ?>
                    ...
                    <div class="mt-2">
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1"><?php echo e($project->progress); ?>% <?php echo e(__('app.complete')); ?></p>
                    </div>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <p class="text-gray-500 dark:text-gray-400 text-center py-4"><?php echo e(__('app.no_recent_projects')); ?></p>
            <?php endif; ?>
        </div>
        <div class="p-4 border-t border-gray-200 dark:border-gray-700">
            <a href="<?php echo e(route('projects.index')); ?>" class="text-primary-600 dark:text-primary-400 hover:text-primary-700 text-sm font-medium">
                <?php echo e(__('app.view_all_projects')); ?> →
            </a>
        </div>
    </div>
</div>
