...
<?php $__env->startSection('title', 'Import Conceptions'); ?>
<?php $__env->startSection('page-title', 'Import Conceptions from Excel'); ?>
...
<div class="max-w-4xl">
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        ...
        <div class="mb-6">
            <a href="<?php echo e(route('conceptions.template')); ?>" 
        ...
        <!-- Import Form -->
        <form method="POST" action="<?php echo e(route('conceptions.import')); ?>" enctype="multipart/form-data" class="space-y-6">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Espacegamers\Documents\bendaikh project\resources\views/conceptions/import.blade.php ENDPATH**/ ?>