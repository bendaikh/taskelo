            ...
            <ul class="space-y-2">
                <li>
                    <a href="<?php echo e(route('dashboard')); ?>" 
                       ...
                       class="flex items-center px-4 py-3 rounded-lg transition-colors <?php echo e(request()->routeIs('dashboard') ? 'bg-primary-100 dark:bg-primary-900 text-primary-700 dark:text-primary-300' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>">
                ...
                <li>
                    <a href="<?php echo e(route('projects.index')); ?>" 
                       onclick="if(window.innerWidth < 1024) toggleSidebar();"
                       class="flex items-center px-4 py-3 rounded-lg transition-colors <?php echo e(request()->routeIs('projects.*') ? 'bg-primary-100 dark:bg-primary-900 text-primary-700 dark:text-primary-300' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <li>
                    <a href="<?php echo e(route('daily-tasks.index')); ?>" 
                       onclick="if(window.innerWidth < 1024) toggleSidebar();"
                       class="flex items-center px-4 py-3 rounded-lg transition-colors <?php echo e(request()->routeIs('daily-tasks.*') ? 'bg-primary-100 dark:bg-primary-900 text-primary-700 dark:text-primary-300' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"></path>
                        </svg>
                        <?php echo e(__('app.daily_tasks')); ?>
                ...
                <li>
                    <a href="<?php echo e(route('payments.index')); ?>" 
                       onclick="if(window.innerWidth < 1024) toggleSidebar();"
                       class="flex items-center px-4 py-3 rounded-lg transition-colors <?php echo e(request()->routeIs('payments.*') ? 'bg-primary-100 dark:bg-primary-900 text-primary-700 dark:text-primary-300' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <li>
                    <a href="<?php echo e(route('proposals.index')); ?>" 
                       onclick="if(window.innerWidth < 1024) toggleSidebar();"
                       class="flex items-center px-4 py-3 rounded-lg transition-colors <?php echo e(request()->routeIs('proposals.*') ? 'bg-primary-100 dark:bg-primary-900 text-primary-700 dark:text-primary-300' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                        </svg>
                        <?php echo e(__('app.proposals')); ?>
                ...
                <li>
                    <a href="<?php echo e(route('conceptions.index')); ?>" 
                       onclick="if(window.innerWidth < 1024) toggleSidebar();"
                       class="flex items-center px-4 py-3 rounded-lg transition-colors <?php echo e(request()->routeIs('conceptions.*') ? 'bg-primary-100 dark:bg-primary-900 text-primary-700 dark:text-primary-300' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path>
                        </svg>
                        <?php echo e(__('app.conception')); ?>
                ...
                <li>
                    <a href="<?php echo e(route('revenues.index')); ?>" 
                       onclick="if(window.innerWidth < 1024) toggleSidebar();"
                       class="flex items-center px-4 py-3 rounded-lg transition-colors <?php echo e(request()->routeIs('revenues.*') ? 'bg-primary-100 dark:bg-primary-900 text-primary-700 dark:text-primary-300' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        </svg>
                        <?php echo e(__('app.revenue')); ?>
                ...
                <li>
                    <a href="<?php echo e(route('revenue-categories.index')); ?>" 
                       onclick="if(window.innerWidth < 1024) toggleSidebar();"
                       class="flex items-center px-4 py-3 rounded-lg transition-colors <?php echo e(request()->routeIs('revenue-categories.*') ? 'bg-primary-100 dark:bg-primary-900 text-primary-700 dark:text-primary-300' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16" />
                        </svg>
                        <?php echo e(__('app.revenue_categories')); ?>
                ...
                <li x-data="{ open: <?php echo e(request()->routeIs('expenses.*') || request()->routeIs('expense-categories.*') ? 'true' : 'false'); ?> }">
                    <button @click="open = !open" class="w-full flex items-center px-4 py-3 rounded-lg transition-colors <?php echo e(request()->routeIs('expenses.*') || request()->routeIs('expense-categories.*') ? 'bg-primary-100 dark:bg-primary-900 text-primary-700 dark:text-primary-300' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>">
                        ...
                        <span class="flex-1 text-left"><?php echo e(__('app.expenses')); ?></span>
                ...
                <li x-data="{ open: <?php echo e(request()->routeIs('roles.*') || request()->routeIs('users.*') ? 'true' : 'false'); ?> }">
                    <button @click="open = !open" class="w-full flex items-center px-4 py-3 rounded-lg transition-colors <?php echo e(request()->routeIs('roles.*') || request()->routeIs('users.*') ? 'bg-primary-100 dark:bg-primary-900 text-primary-700 dark:text-primary-300' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>">
                        ...
                        <span class="flex-1 text-left"><?php echo e(__('app.user_management')); ?></span>
                        <svg class="w-4 h-4 transition-transform" :class="{ 'rotate-90': open }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                        </svg>
                    </button>
                ...
                <li>
                    <a href="<?php echo e(route('settings')); ?>" 
                       onclick="if(window.innerWidth < 1024) toggleSidebar();"
                       class="flex items-center px-4 py-3 rounded-lg transition-colors <?php echo e(request()->routeIs('settings') ? 'bg-primary-100 dark:bg-primary-900 text-primary-700 dark:text-primary-300' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
