...
<?php $__env->startSection('title', __('app.projects')); ?>
<?php $__env->startSection('page-title', __('app.projects')); ?>
...
<div class="mb-6 flex flex-col md:flex-row md:justify-between md:items-center space-y-4 md:space-y-0">
    ...
    <form method="GET" action="<?php echo e(route('projects.index')); ?>" class="flex flex-wrap items-center gap-2">
        ...
        <select 
            ...
            <option value="planning" <?php echo e(request('status') === 'planning' ? 'selected' : ''); ?>><?php echo e(__('app.pending')); ?></option>
            <option value="active" <?php echo e(request('status') === 'active' ? 'selected' : ''); ?>><?php echo e(__('app.active')); ?></option>
            <option value="on_hold" <?php echo e(request('status') === 'on_hold' ? 'selected' : ''); ?>><?php echo e(__('app.on_hold')); ?></option>
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="p-6">
                ...
                <div class="space-y-2 mb-4 text-sm">
                    <div class="flex justify-between">
                        <span class="text-gray-500 dark:text-gray-400"><?php echo e(__('app.budget')); ?>:</span>
                    ...
                    <div class="flex justify-between">
                        <span class="text-gray-500 dark:text-gray-400"><?php echo e(__('app.paid')); ?>:</span>
                        <span class="text-green-600 font-medium"><?php echo e(Auth::user()->currency); ?> <?php echo e(number_format($project->amount_paid, 2)); ?></span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-gray-500 dark:text-gray-400"><?php echo e(__('app.pending')); ?>:</span>
                ...
                <div class="mb-4">
                    <div class="flex justify-between text-xs text-gray-500 dark:text-gray-400 mb-1">
                        <span><?php echo e(__('app.progress')); ?></span>
                ...
                <?php if($project->start_date || $project->end_date): ?>
                    <div class="text-xs text-gray-500 dark:text-gray-400 mb-4">
                        <?php if($project->start_date): ?>
                            <?php echo e(__('app.start_date')); ?>: <?php echo e($project->start_date->format('M d, Y')); ?>

                        <?php endif; ?>
                        <?php if($project->start_date && $project->end_date): ?> | <?php endif; ?>
                        <?php if($project->end_date): ?>
                            <?php echo e(__('app.end_date')); ?>: <?php echo e($project->end_date->format('M d, Y')); ?>
                ...
                <div class="flex justify-between items-center pt-4 border-t border-gray-200 dark:border-gray-700">
                    ...
                    <div class="flex space-x-2">
                        <a href="<?php echo e(route('projects.edit', $project)); ?>" class="text-blue-600 hover:text-blue-900 dark:text-blue-400 text-sm"><?php echo e(__('app.edit')); ?></a>
                        <form action="<?php echo e(route('projects.destroy', $project)); ?>" method="POST" class="inline" onsubmit="return confirm('<?php echo e(__('app.are_you_sure')); ?>');">
                            <?php echo csrf_field(); ?>
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
        <div class="col-span-full text-center py-12 bg-white dark:bg-gray-800 rounded-lg shadow">
            <p class="text-gray-500 dark:text-gray-400 mb-4"><?php echo e(__('app.no_projects')); ?>.</p>
